...
export class SellEquipment extends Component {
  ...
  render() {
    ...
    <div class="container-fluid">
        <div class="row flex-fill">
            <div class="col d-xl-flex justify-content-xl-center"><img src="assets/img/AFL.jpg" style={{"width": "88px"}} /></div>
        </div>
    </div>
</nav>
                    <div className="row">
        ...
        <div class="card shadow-sm mb-3" style={{'background': 'rgb(241,241,241)'}}>
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="col"><iframe allowfullscreen frameborder="0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCxUQw87F0UWpLPVY4cZbfSwvZ_4eKWdbQ&amp;q=india%2C+India&amp;zoom=11" width="100%" height="400"></iframe></div>
                    </div>
                </form>
            </div>
        </div>
