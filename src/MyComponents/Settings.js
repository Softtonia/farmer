            ...
            <div>
                ...
                <div id="wrapper" >
                    ...
                    <div className="page-content-wrapper pt-3">
                        <div class="container-fluid pt-3" style={{"padding-left":"60px"}}>
                            <div class="row" style={{"margin-bottom": "100px"}}>
                                <div class="col-4" style={{"width": "334px","max-width": "329px"}}>
                                    <Link to="/profile"> <button onClick={(e)=>{console.log('Edit Profile Clicked')}} class="btn btn-primary btn-block btn-lg" type="button" style={{"height": "170px","backgroundColor":"#172578","marginLeft":"300px"}}><i class="fa fa-edit"></i> Edit Profile</button></Link></div>
                            </div>
                            <div class="row" style={{"margin-bottom": "100px"}}>
                                <div class="col-4" style={{"width": "334px","max-width": "329px"}}>
                                    <button onClick={(e)=>{console.log('Security Clicked')}} class="btn btn-primary btn-block btn-lg" type="button" style={{"height": "170px","backgroundColor":"#172578","marginLeft":"300px","marginTop":"200px"}} data-toggle="modal" data-target="#changePassword" data-whatever="@mdo"><i class="fa fa-lock"></i> Security</button></div>
                            </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Update</button>
                ...
                <div className="text-right" style={{ "margin-right": "50px" }}>
                  <img src="assets/img/AFL.jpg" style={{ width: "108px",marginTop:"100px" }} />
                </div>
            </div>
        )
    }
