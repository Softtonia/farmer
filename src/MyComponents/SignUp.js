        ...
        <div className="row">
            ...
            <div className="col-lg-5 col-xl-5" style={{"background": "#ffffff","min-height": "888px"}}>
                ...
                <form className="text-center" style={{"padding": "68px"}}>
                    ...
                    <Link to="/"><button className="btn btn-primary btn-block mb-5" type="button" onClick={()=>{console.log('Signup Button Clicked');}} >Sign Up</button></Link>
                    <Link to="/"><button className="btn btn-info btn-block" onClick={()=>{console.log('Login Button Clicked');}} type="button">Already Have an account .. Login</button></Link></form>
                <div>
