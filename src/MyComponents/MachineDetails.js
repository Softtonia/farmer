        ...
        <div class="row">
            <div class="col-9 text-center" style={{"padding": "81px","background": "rgb(248,248,255)"}}>
                <div class="row" style={{"margin-top": "25px"}}>
                    <div class="col"><img class="border rounded shadow-sm" src="assets/img/Tractor1.png" /></div>
                </div>
                <div class="row" style={{"margin-top": "25px"}}>
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body"><textarea class="form-control" placeholder="Add Review"></textarea><button class="btn btn-primary m-3" type="button">Add Review</button>
                                <div class="btn-group" role="group"><button class="btn btn-info" type="button" onClick={()=>{navigate('/cart')}}>Add to Cart</button><button class="btn btn-success" type="button">Buy</button></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="text-right" style={{ marginLeft: "1300px" }}>
                              <img src="assets/img/AFL.jpg" style={{ width: "108px" ,marginTop:"5px"}} />
                            </div>
            {/* <div class="col" style={{"min-height": "600px", "width": "500px", "backgroundColor": "#172578"}}><img class="img-fluid" style={{"height": "100px", "width": "250px", "marginLeft": "80px", "backgroundColor": "#172578"}} src="assets/img/AFL.jpg"/></div> */}
        </div>
    </div>
      </div>
      </div>
