      ...
      <div className="container-fluid"><a className="navbar-brand" href="#">
          ...
          <div
              ...
              <ul className="nav navbar-nav flex-fill">
                  <Link to="/buy"><li className="nav-item"><a className="nav-link active" href="#">New Car</a></li></Link>
                  ...
                  <Link to="/sell"><li className="nav-item"><a className="nav-link" href="#">Sell</a></li></Link>
              ...
              <ul className="nav navbar-nav d-inline-flex d-xl-flex align-self-end">
                  <Link to="/Signup"><li className="nav-item"><a className="nav-link active text-muted" href="#"><i className="fa fa-user"></i> Sign-In</a></li></Link>
                  {/* <li className="nav-item">
